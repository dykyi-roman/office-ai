...
OfficeAI is a Tauri v2 desktop application that visualizes running AI agents (Claude Code, ChatGPT, Gemini) as animated employees in an isometric 2D office. The "zero-intrusion" principle means passive observation without modifying agent processes.
